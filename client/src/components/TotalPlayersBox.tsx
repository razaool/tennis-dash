  ...
  return (
    <div className={className}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', height: 'calc(100% - 2rem)' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '2rem', color: '#00d9ff', fontWeight: 'bold' }}>{summary.totals.matches}</div>
          <div style={{ fontSize: '0.7rem', color: '#707070', textTransform: 'uppercase' }}>Matches</div>
        </div>
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '2rem', color: '#ffaa00', fontWeight: 'bold' }}>{summary.totals.tournaments}</div>
